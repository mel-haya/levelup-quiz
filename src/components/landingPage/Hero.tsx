...
export default function Hero() {
  return (
      <main className=" relative overflow-hidden flex items-center justify-center grow text-white">
        ...
        <div className='flex flex-col md:flex-row items-center'>
          <div className="flex gap-4 items-center z-10 px-4 flex-col">
              <h1 className={`text-4xl font-bold text-center ${funnel.className}`} >Generate Your Own Quiz in Seconds</h1>
              <h2 className={`text-xl text-center ${funnel.className}`} >Create personalized quizzes effortlessly. Just describe what you need, and we’ll handle the rest!</h2>
              <Button/>
          </div>
          <QuizAnimation/>
        </div>
